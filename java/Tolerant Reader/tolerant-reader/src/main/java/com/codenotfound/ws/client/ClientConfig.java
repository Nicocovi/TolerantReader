...
public class ClientConfig {
  ...
  @Value("${client.xpath.order-name}")
  private String orderNameXPath;
  
  @Value("${client.xpath.order-description}")
  private String orderDescriptionXPath;
  ...
  @Bean
  public XPathExpression orderNameXPath() {
    return XPathExpressionFactory.createXPathExpression(orderNameXPath);
  }
  
  @Bean
  public XPathExpression orderDescriptionXPath() {
    return XPathExpressionFactory.createXPathExpression(orderDescriptionXPath);
  }
